...
$(if $(PKG_NAME),Source-Name: $(PKG_NAME)
)$(if $(PKG_BUILD_DIR),Build-Dir: $(PKG_BUILD_DIR)
)$(if $(PKG_SOURCE_URL),Source-URL: $(PKG_SOURCE_URL)
)$(if $(PKG_SOURCE_PROTO),Source-Protocol: $(PKG_SOURCE_PROTO)
